<template>
  <transition :name="$store.state.detail.transitionName">
    <div class="detail"
      ...
      <div class="contents">
        <!--标题-->
        <div class="title">{{$store.state.detail.news.title}}</div>
      ...
      <span class="left">
        ...
        <!--正文-->
        <template v-for="(item, i) in $store.state.detail.news.contents">
